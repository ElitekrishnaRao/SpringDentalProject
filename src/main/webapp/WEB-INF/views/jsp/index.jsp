					...
					<div class="banner1">
						<div class="container">
							<div class="banner-info">
								...
								<p>A dentist, also known in the U.S. as a dental surgeon, is a surgeon who specializes in 
								dentistry diagnosis, prevention, and treatment of diseases and conditions of the oral cavity. 
								The dentist's supporting team aids in providing oral health services. The dental team includes dental assistants, 
								dental hygienists, dental technicians, and in some states, dental therapists..</p>
							...
							<div class="login-grids">
									...
									<div class="login-right">
										...
										<form action="<c:url value='j_spring_security_check'/>" method="post">
											<div class="sign-in">
												<h4>Email :</h4>
												<input type="text"  name="j_username" value="Type here" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Type here';}" required="">	
											</div>
											<div class="sign-in">
												<h4>Password :</h4>
												<input type="password"  name="j_password" value="Password" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Password';}" required="">
